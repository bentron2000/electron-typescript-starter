...
export const createMockData = (db: Realm) => {
  ...
  db.write(() => {
    // TEMPLATES
    const template: TemplateEntity = db.create('Template', TemplateEntity.templateToEntity(emptyProject, undefined)) // allow undefined for the moment
    ...
    // TEAMS
    const team1: TeamEntity = db.create('Team', { id: 't1', name: 'Sequitur', seats: [], projects: [], owners: [seat1], admins: [seat1, seat2], templates: [] }, true )

    // USERS
    const user1: UserEntity = db.create('User', { id: 'u1', name: 'Naomi', seats: [] }, true )
    const user2: UserEntity = db.create('User', { id: 'u2', name: 'Grippi', seats: [] }, true )
   ...
   // STAGE PERMISSIONS
    ...
    // TREE DEFINITION
    const def_l0_Root: TreeDefinitionEntity = db.create( 'TreeDefinition', { id: 'def_l0_Root', name: 'Root', instances: [], children: [], project: [project1], parent: [], mediaAllowed: false, collaboratorMode: false }, true )
    const def_l1_Department: TreeDefinitionEntity = db.create( 'TreeDefinition', { id: 'def_l1_Department', name: 'Department', instances: [], children: [], project: [project1], parent: [], mediaAllowed: false, collaboratorMode: false }, true )
    const def_l2_Category: TreeDefinitionEntity = db.create( 'TreeDefinition', { id: 'def_l2_Category', name: 'Category', instances: [], children: [], project: [project1], parent: [], mediaAllowed: false, collaboratorMode: false }, true )
    const def_l3_Product: TreeDefinitionEntity = db.create( 'TreeDefinition', { id: 'def_l3_Product', name: 'Product', instances: [], children: [], project: [project1], parent: [], mediaAllowed: false, collaboratorMode: false }, true )
    const def_l4_View: TreeDefinitionEntity = db.create( 'TreeDefinition', { id: 'def_l4_View', name: 'View', instances: [], children: [], project: [project1], parent: [], mediaAllowed: true, collaboratorMode: true }, true )
